...
void Shop::AparaceShop(){
    if(!LV.WavesCount==true){
            ...
            shopobj.shopbasesource = (Rectangle){static_cast<float>(shopobj.State*OBJ_SIZE_BIG),0,64,OBJ_SIZE_BIG};
...
void Shop::BuyInShop(){
            ...
            shoptender.shoptendersource = (Rectangle){static_cast<float>(shoptender.State*OBJ_SIZE_BIG),0,64,OBJ_SIZE_BIG};

            ///=== ANIM Shop ==//
            shopobj.State = ShopAnimation();
            shopobj.shopbasesource = (Rectangle){static_cast<float>(shopobj.State*OBJ_SIZE_BIG),0,OBJ_SIZE_BIG,OBJ_SIZE_BIG};
